...
#' @title volcano plot ANOVA
#'
#' @description
#' \code{volcanoPlotANOVA} volcano plot for the results of the ANOVA on mutations
#'
#' @details
#' Plot effect size versus -log 10 p-value for the results of the ANOVA (computed using python package from GDSC)
#' @param ANOVA_results table with the results
#' @param th_effectSize
#' @param th_pVal
#' 
#' @return Volcano plot

volcanoPlotANOVA <- function(ANOVA_results, th_effectSize, th_pVal){
  currentFolder<-getwd()
